...
export const heroConfig = {
  ...
  description: {
    template:
      'I build interactive web apps using {{skills.Excel}}, {{skills.Figma}}, and {{skills.PowerBI}}. With a focus on <b>UI</b> design. Enthusiastic about <b>Three.js</b>, driven by a keen eye for design.',
  },
